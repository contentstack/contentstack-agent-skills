...
description: "Explain Templates — they compose Sections into a page-shape, rendering against a content type at a derived URL pattern (one Template → N live pages)."
