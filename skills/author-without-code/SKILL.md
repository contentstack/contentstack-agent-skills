---
name: author-without-code
description: "End-to-end authoring path for content teams on a Studio project a developer has already set up — pick a template, bind data, preview, save, publish — no code required."
