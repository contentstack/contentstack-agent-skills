---
name: build-freeform-template
description: "Author a Freeform (Static) template with Additional Entry Data pins and Pinned Queries. Connected is the default; Freeform is the last resort."
