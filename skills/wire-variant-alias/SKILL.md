---
name: wire-variant-alias
description: "Replace a route-level user-state branch with a Contentstack Personalize-driven render — read variant alias from cookies/headers, pass to `<StudioComponent />` via `variantAlias` query option."
