...
description: "Bootstrap a Studio project via API — create the compositions CT with the schema Studio's editor + runtime require, plus the publish + delivery-token setup."
