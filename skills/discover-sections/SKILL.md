...
description: "Scan all route files and propose Studio Section candidates by finding components that recur across routes. Outputs a section inventory prioritised by reuse count."
