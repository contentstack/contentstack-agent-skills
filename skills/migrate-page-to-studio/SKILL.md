...
description: "FINAL step of a section-first migration: swap one route from hand-coded JSX to `<StudioComponent />` after components, sections, and template exist in Studio."
