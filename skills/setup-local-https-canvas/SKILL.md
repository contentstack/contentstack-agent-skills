---
name: setup-local-https-canvas
description: "Set up a locally-trusted HTTPS cert (via mkcert) for the canvas-app. NOT required for most local-dev — browsers treat `localhost` as trusted and allow Studio to iframe `http://localhost:<port>`."
