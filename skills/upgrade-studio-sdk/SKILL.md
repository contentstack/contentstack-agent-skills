---
name: upgrade-studio-sdk
description: "Bump the Studio SDK packages (studio-react, studio-react-components, studio-client, studio-registry, studio-core, studio-internal, studio-react-editor) in the host app — pin versions, read CHANGELOGs, smoke-check, roll back if needed."
