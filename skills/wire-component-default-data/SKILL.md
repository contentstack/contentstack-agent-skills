...
description: "Add per-prop `defaultValue` to a registered Studio component so it renders visibly the moment an author drops it on the canvas — before any data binding."
