---
name: pin-entry-to-freeform
description: "Pin a Contentstack entry to a Freeform template via the Additional Entry Data section so components on that template can bind to the entry's fields."
