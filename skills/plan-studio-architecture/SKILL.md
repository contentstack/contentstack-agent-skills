...
description: "Take a project's requirements and print an architecture plan — which pieces are Sections, which pages are Connected templates, which CTs + Global Fields, build order."
