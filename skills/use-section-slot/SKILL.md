...
description: "Carve a Section Slot into an already-designed section so template authors drop components into a named placeholder without unlocking the surrounding design. Path B (default) — Section-with-Slot + child Section."
