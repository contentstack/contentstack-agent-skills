...
description: "Configure a Studio project's Environment, Language, and Canvas URL in one guided pass — replacing manual clicking through the Studio settings panels."
