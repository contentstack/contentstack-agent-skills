...
description: "Optionally install + OAuth-authenticate the Contentstack MCP server so provisioning skills run CMA operations as tool calls instead of raw curl, with no manually-pasted authtoken."
