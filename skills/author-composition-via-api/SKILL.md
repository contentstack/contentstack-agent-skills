...
description: "Author Studio compositions by writing composition JSON via the CMA — the manual contract Studio's Data Picker hides. For headless / scripted / seed-pipeline projects, not interactive UI authors."
